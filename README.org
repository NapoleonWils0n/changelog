...
#+RESULTS: cerberus
#+begin_quote
| 26a3e7eb | nmcli                      | 16:35:10/19-07-2025 | HEAD -> master, github/master, github/HEAD |
...
#+RESULTS: nixos-bin
#+begin_quote
| 714d4fd  | backup to usb check if mountpoint is mounted | 15:23:36/19-07-2025 | HEAD -> master, github/master |
